...
namespace Group03_Kindergarten_Suggestion_System_Project.Areas.Administration.Controllers
{
    ...
    public class SchoolFacilitiesController: Controller
    {
        ...
        public SchoolFacilitiesController(KindergartenSSDatabase context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            ...
            ViewBag.Utilities = await _context.Facilities.ToListAsync();
            return View(school);
        }
        ...
        public async Task<IActionResult> AddUtility(Guid schoolId, Guid utilityId)
        {
            ...
            if (school.SchoolFacilities.Any(su => su.FacilityId == utilityId))
            {
            ...
            var schoolUtility = new SchoolFacility
            {
                SchoolId = schoolId,
                FacilityId = utilityId
            };

            _context.SchoolFacilities.Add(schoolUtility);
        ...
        {
            var schoolUtility = await _context.SchoolFacilities
                .FirstOrDefaultAsync(su => su.SchoolId == schoolId && su.FacilityId == utilityId);
            ...
            _context.SchoolFacilities.Remove(schoolUtility);
            await _context.SaveChangesAsync();
